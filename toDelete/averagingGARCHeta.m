...
thetaOriginal  = garchDrawCoefficients1(N, seedCoefficients);
meanCoef = [1, 0.25, 0.25]';

% Set range to be explored. Loop trough the GARCH parameter alpha
alphaRange = 0.1:0.01:0.5;
endOfRange= length(alphaRange);
...
for j=1:endOfRange
   ...
   thetaLoop =    garchChangeCoordinateAlpha(alphaRange(j), thetaOriginal);
...
subplot(1,3,1)
    plot(alphaRange,varianceSample1./varianceIndividual,'c','LineWidth',2) % optimal
    hold on
    plot(alphaRange,varianceEqual1./varianceIndividual,'--')
    plot(alphaRange, varianceStein1./varianceIndividual, '.-')
    plot(alphaRange, varianceAIC1./varianceIndividual, '.-')
...
subplot(1,3,2)
    plot(alphaRange,varianceSample2./varianceIndividual,'c','LineWidth',2) % optimal
    hold on
    plot(alphaRange,varianceEqual2./varianceIndividual,'--')
    plot(alphaRange, varianceStein2./varianceIndividual, '.-')
    plot(alphaRange, varianceAIC2./varianceIndividual, '.-')
...
subplot(1,3,3)
    plot(alphaRange,varianceSampleAll./varianceIndividual,'c','LineWidth',2) % optimal
    hold on
    plot(alphaRange,varianceEqualAll./varianceIndividual,'--')
    plot(alphaRange, varianceStein./varianceIndividual, '.-')
    plot(alphaRange, varianceAIC./varianceIndividual, '.-')
