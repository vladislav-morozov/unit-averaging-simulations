function [coverageTable, lengthTable] = ...
    processCoverageLength(...
        coverageArrayTarget, lengthArrayTarget, paramArray)
% processCoverageLength Estimates confidence interval coverage and length.
%
...
%         - Same structure as `coverageTable`.
    ...
    coverageTables = ...
        processOneValueEstimates(coverageArrayTarget, paramArray);
    lengthTables = ...
        processOneValueEstimates(lengthArrayTarget, paramArray);
